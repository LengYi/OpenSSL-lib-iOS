...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of OpenSSL-lib-iOS.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/707689817@qq.com/OpenSSL-lib-iOS'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '707689817@qq.com' => '707689817@qq.com' }
  s.source           = { :git => 'https://github.com/707689817@qq.com/OpenSSL-lib-iOS.git', :tag => s.version.to_s }
